...
pkgdatadir = $(datadir)/KoboDeluxe
pkglibdir = $(libdir)/KoboDeluxe
pkgincludedir = $(includedir)/KoboDeluxe
top_builddir = .
...
ACLOCAL = ${SHELL} /home/kuwanger/gcw_zero/kobodeluxe-0.5.1.new/missing --run aclocal-1.9
AMDEP_FALSE = #
AMDEP_TRUE = 
AMTAR = ${SHELL} /home/kuwanger/gcw_zero/kobodeluxe-0.5.1.new/missing --run tar
AUDIO_LIBS = 
AUTOCONF = ${SHELL} /home/kuwanger/gcw_zero/kobodeluxe-0.5.1.new/missing --run autoconf
AUTOHEADER = ${SHELL} /home/kuwanger/gcw_zero/kobodeluxe-0.5.1.new/missing --run autoheader
AUTOMAKE = ${SHELL} /home/kuwanger/gcw_zero/kobodeluxe-0.5.1.new/missing --run automake-1.9
AWK = gawk
BUILD_MACOSX_BUNDLE_FALSE = 
BUILD_MACOSX_BUNDLE_TRUE = #
BUILD_SIMPLE_BUNDLE_FALSE = 
BUILD_SIMPLE_BUNDLE_TRUE = #
CC = mipsel-linux-gcc
...
LDFLAGS = 
LIBOBJS =  ${LIBOBJDIR}memcmp$U.o ${LIBOBJDIR}strtod$U.o ${LIBOBJDIR}lstat$U.o ${LIBOBJDIR}stat$U.o
LIBS = -lSDL_image  -L/usr/lib/x86_64-linux-gnu -lSDL -lSDL_image
LOCALCFLAGS = 
LTLIBOBJS =  ${LIBOBJDIR}memcmp$U.lo ${LIBOBJDIR}strtod$U.lo ${LIBOBJDIR}lstat$U.lo ${LIBOBJDIR}stat$U.lo
MAKEINFO = ${SHELL} /home/kuwanger/gcw_zero/kobodeluxe-0.5.1.new/missing --run makeinfo
MATHLIB = -lm
OBJEXT = o
PACKAGE = KoboDeluxe
PACKAGE_BUGREPORT = 
...
SCOREDIR = "HOME>>/.kobo-deluxe/scores"
...
install_sh = /home/kuwanger/gcw_zero/kobodeluxe-0.5.1.new/install-sh
...
#bundle_contents = KoboDeluxe
#bundle_contents = KoboDeluxe.app/Contents
kobo_scoredir = $(sharedstatedir)/kobo-deluxe/scores
INCLUDES = -DKOBO_DATA_DIR=\""$(datadir)/kobo-deluxe"\"		\
		-DKOBO_SCORE_DIR=\""$(kobo_scoredir)"\"	\
		-DKOBO_CONFIG_DIR=\""HOME>>"\"	\
		-DKOBO_CONFIG_FILE=\"".kobodlrc"\"	\
		-DSYSCONF_DIR=\""$(sysconfdir)"\"	\
		-Isound -Igraphics -Ieel -Idata/sfx 

SUBDIRS = graphics sound data eel
GRAPHICS_LIB = graphics/libgraphics.a -lm
SOUND_LIB = sound/libsound.a 
...
#KoboDeluxe_bundle: ${EXEFILE}
#	mkdir -p $(bundle_contents)/MacOS
#	echo "APPL????" > $(bundle_contents)/PkgInfo
#	$(INSTALL_DATA) Info.plist $(bundle_contents)
#	$(INSTALL_PROGRAM) ${EXEFILE} $(bundle_contents)/MacOS/

#install-exec-hook: KoboDeluxe_bundle
#	rm -rf $(DESTDIR)$(prefix)/KoboDeluxe.app
#	mkdir -p $(DESTDIR)$(prefix)/
#	cp -r KoboDeluxe.app $(DESTDIR)$(prefix)/
...
#install-exec-hook: KoboDeluxe_bundle
#	rm -rf $(DESTDIR)/$(prefix)/KoboDeluxe
#	mkdir -p $(DESTDIR)/$(prefix)/
#	cp COPYING KoboDeluxe/COPYING.txt
#	cp COPYING.LIB KoboDeluxe/COPYING_LIB.txt
#	cp ChangeLog KoboDeluxe/ChangeLog.txt
#	cp TODO KoboDeluxe/TODO.txt
#	cp README KoboDeluxe/README.txt
#	cp README.jp KoboDeluxe/README_jp.txt
#	cp README.sfont KoboDeluxe/sfont.txt
#	cp README.xkobo KoboDeluxe/xkobo.txt
#	cp README.xkobo.jp KoboDeluxe/xkobo_jp.txt
#	cp KoboPlayer KoboDeluxe/scores/42
#	cp -r KoboDeluxe	 $(DESTDIR)/$(prefix)/
